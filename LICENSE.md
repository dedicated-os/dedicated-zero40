...
Modified versions must be clearly identified as modified and must not use the project name, assets, branding, typefaces, or overall identity in a way that a reasonable user could confuse with the original project or assume is endorsed by the original author.

Third-party code, assets, tools, and libraries remain under their original licenses.